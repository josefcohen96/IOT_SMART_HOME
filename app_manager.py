...
def on_message(client, userdata, msg):
    ...
    if float(m_decode.split(': ')[1]) < trash_valume_THR:
        ic("Threshold warning! Empty the trash can: " + m_decode.split(': ')[1])
        send_msg(client, topic_alarm, "Threshold warning! Empty the trash can : " + m_decode.split(': ')[1]+" space left")
